...
def main():
    ...
    print("  2. Store trained weights to vault (tagged as 'cat')")
    print("  3. Second training: Same cat task, vault-initialized")
    ...
    vault = DetectionWeightVault(
        ...
        top_k_ratio=0.3,
        vault_path="../cat_detection_vault"
    )
...
Files created:
  - ../cat_detection_vault/: Contains stored cat detection weights
"""
