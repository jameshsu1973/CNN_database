...
class DBConv2d(nn.Conv2d):
    ...
    def _initialize_from_vault(self):
        ...
        # Query vault for similar weights
        vault_weights = DBConv2d._vault.get_initialization_weights(self)
...
class DBLinear(nn.Linear):
    ...
    def _initialize_from_vault(self):
        ...
        vault_weights = DBLinear._vault.get_initialization_weights(self)
...
def create_db_cnn(vault: WeightVault, num_classes: int = 10) -> nn.Module:
    ...
    class DBCNN(nn.Module):
        def __init__(self, num_classes=10):
            super().__init__()
            self.conv1 = DBConv2d(1, 32, kernel_size=3, padding=1)
